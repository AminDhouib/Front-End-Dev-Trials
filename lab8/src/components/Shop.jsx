...
// Buy Popup
const PopupExample = () => (
  <Popup trigger={<Button className="bg-secondary">Buy Game Code</Button>} position="right center">
...
<br/>
         ...
         <div className="d-flex justify-content-center">
           <h1 className="text-secondary float-none"><strong>Video Game Selections</strong></h1>
         </div>
  ...
  <div class="col">
    <div className="container"><br/>
      ...
      <div className="card-body text-white">
        ...
        <p className="card-text">
          Super Mario Odyssey is a platform 
          ...
          to rescue Princess Peach from Bowser, who plans to forcibly marry her.</p>
          
          Release Date: 2017
          <br></br>

          Price: 59.99$<br/><PopupExample/>
      </div>
      </div><br/>
      </div>
      </div>
    ...
    <div className="container"><br/>
      ...
      <div className="card-body text-white">
        ...
        including weapons, food, and other resources.</p>
  ...
  <div class="col">
    <div className="container"><br/>
      ...
      <div className="card-body text-white">
        ...
        <p className="card-text">
        Uncharted 4: A Thief's End is an action-adventure 
        ...
        locations including towns, buildings and wilderness to advance through the game's story.</p>
          
          Release Date: 2016
          <br></br>

          Price: 19.99$<br/><PopupExample/>
      </div>
      </div><br/>
      </div>
      </div>
    ...
    <div className="container"><br/>
      ...
      <div className="card-body text-white">
        ...
        Overwatch is a team-based multiplayer first-person shooter
         ...
         on a map or escort a payload across the map in a limited amount of time.</p>
          
          Release Date: 2014
          <br></br>

          Price: 29.99$<br/><PopupExample/>
      </div>
      </div><br/>
      </div>
      </div>
    ...
    <div className="container"><br/>
      ...
      <div className="card-body text-white">
        ...
        this version of the game, it comes with the new Shadowlands expansion!</p>
          ...
          Price: 19.99$ / Month <br/><PopupExample/>
      </div>
      </div><br/>
      </div>
      </div>
