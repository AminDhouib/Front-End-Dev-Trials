...
module.exports = function (app) {
    ...
    app.get('/analysis', function (req, res) {
        ...
        var goodTraits = readData("goodTraits");
        var frequency = readData("frequency");
        var feedback = readData("feedback");
        var confident = readData("confident");

        res.render('showResults', {
            results: [name, gender, goodTraits, frequency, feedback, confident]
        });
    });
    ...
    app.post('/niceSurvey', urlencodedParser, function (req, res) {
        ...
        for (var key in json) {
            ...
            if ((key === "goodTraits") && (json[key].length === 2)) {
